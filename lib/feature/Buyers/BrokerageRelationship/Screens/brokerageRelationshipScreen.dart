...
class BrokerageRelationshipScreen extends StatefulWidget {
  const BrokerageRelationshipScreen({super.key});

  @override
  State<BrokerageRelationshipScreen> createState() =>
      _BrokerageRelationshipScreenState();
}

class _BrokerageRelationshipScreenState
    extends State<BrokerageRelationshipScreen> {
  // Colors
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // 3. Body Description
            Text(
              'State law asks us to share a quick real-estate disclosure before helping with showings. It’s not a contract and doesn’t mean you’re working with us exclusively.View this anytime in your profile.',
